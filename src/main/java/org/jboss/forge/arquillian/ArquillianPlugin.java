...
import org.jboss.forge.arquillian.ContainerInstaller;
...
public class ArquillianPlugin implements Plugin {
    ...
    public void installContainer(
            ...
            @Option(name = "containerName", required = false, completer = ContainerCommandCompleter.class) String containerId,
            @Option(name = "testframework", required = false, defaultValue = "testng") String testframework) {
